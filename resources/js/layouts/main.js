...
(function () {
    ...
    localStorage.setItem("primaryRGB", "94, 167, 203");
    ...
    if (localStorage.getItem("corporateeventtheme")) {
        ...
        document
            .querySelector("html")
            .setAttribute("data-header-styles", "dark");
    }
    ...
    if (localStorage.getItem("celayout") == "vertical") {
        document
            .querySelector("html")
            .setAttribute("data-nav-layout", "vertical");
    }
    ...
    function localStorageBackup() {
        ...
        if (localStorage.corporateeventtheme) {
            let html = document.querySelector("html");
            html.setAttribute("data-theme-mode", "dark");
        }
        if (localStorage.celayout) {
            let html = document.querySelector("html");
            let layoutValue = localStorage.getItem("celayout");
            html.setAttribute("data-nav-layout", "vertical");
        ...
        if (localStorage.cemenufixed) {
            let html = document.querySelector("html");
            html.setAttribute("data-menu-position", "fixed");
        }
        // if (localStorage.cemenuscrollable) {
        //     let html = document.querySelector("html");
        //     html.setAttribute("data-menu-position", "scrollable");
        // }
        if (localStorage.ceMenu) {
            let html = document.querySelector("html");
            let menuValue = localStorage.getItem("ceMenu");
            switch (menuValue) {
                case "light":
