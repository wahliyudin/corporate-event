...
(() => {
    ...
    if (
        !localStorage.getItem("celayout") &&
        !localStorage.getItem("cenavstyles") &&
        !localStorage.getItem("ceverticalstyles") &&
            ...
            switch (verticalStyle) {
                ...
                case "overlay":
                    ...
                    if (html.getAttribute("data-toggled") === "icon-overlay-close") {
                        ...
                        if (window.innerWidth >= 992) {
                            if (!localStorage.getItem("celayout")) {
    ...
    setTimeout(() => {
        ...
        menuSlideItem.forEach((e) => {
            ...
            e.addEventListener("mouseenter", () => {
                if (window.innerWidth >= 992) {
                    if (localStorage.ceverticalstyles == "doublemenu") {
